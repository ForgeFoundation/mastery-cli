...
class ExtensionModel {
    constructor(name, version, description, author, license = "MIT", options = {}) {
        // Validate required parameters
        if (!name || !version || !description || !author) {
            throw new Error("Extension must provide name, version, description, and author");
        }
    ...
    async initialize(context = {}) {
        try {
            ...
            console.error(`Failed to initialize extension ${this.name}:`, error);
            return false;
        }
    }
     ...
     */
    getHandles(context = {}) {
        throw new Error(`Extension ${this.name} must implement getHandles() method`);
    }
